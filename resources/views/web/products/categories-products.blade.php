    ...
    <div class="tabs">
        <div class="tabbed-product">
            <ul class="nav-center nav navbar tab-links">
                @foreach ($categoryFirst as $item)
                    <li class="active"><a href="#tab_{{$item->slug}}">{{$item->name}}</a></li>
                @endforeach
                @foreach ($categoriesFirst as $item)
                    <li class=""><a href="#tab_{{$item->slug}}">{{$item->name}}</a></li>
                @endforeach
            </ul>
        </div>
        ...
        <div class="wrapper-product">
            <div class="tab-content">
                @foreach ($categoryFirst as $item)
                <div class="tab active" id="tab_{{$item->slug}}">
                ...
                @foreach ($categoriesFirst as $item)
                <div class="tab" id="tab_{{$item->slug}}">
                    <div class="row row-cols-5">
            ...
            <div class="col-inner">
                <div class="icon-box">
                    <div class="icon-box-img">
                        <div class="icon">
                            <div class="icon-inner"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="315.944px"
                                    height="315.943px" viewBox="0 0 315.944 315.943"
                                    style="enable-background:new 0 0 315.944 315.943;" xml:space="preserve">
                                    <g>
                                        <g>
                                            <path
                                            ...
                                            <path
                                                d="M310.542,197.383h-28.931l-83.014,39.624l-3.618,0.016c-50.195,0-90.624-8.88-120.849-19.311L0,247.586h196.673L310.542,197.383z">
                                            </path>
                                            <path
                                                d="M21.146,181.398c21.574,13.632,81.923,45.331,176.217,44.788l109.877-52.445c0,0-5.922,0.032-15.625-0.253l-93.894,42.831l-1.534-0.2c-53.687-6.972-92.027-41.212-116.105-71.542l-57.997,26.259C16.654,173.299,16.103,178.214,21.146,181.398z">
                                            </path>
                                        </g>
                                </svg>
                            </div>
                    ...
                    <div class="icon-box-text">
                        <h3>PROVIDING SPECIAL<br />STATIONERY</h3>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3">
            <div class="col-inner">
                <div class="icon-box">
                    ...
                    <div class="icon-box-text">
                        <h3>PROVIDING DIVERSE<br />STATIONERY</h3>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3">
            <div class="col-inner">
                <div class="icon-box">
                    ...
                    <div class="icon-box-text">
                        <h3>MODERN SHOPPING<br />– CONVENIENT –</h3>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3">
            <div class="col-inner">
                <div class="icon-box">
                    <div class="icon-box-img">
                        <div class="icon">
                            <div class="icon-inner"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    viewBox="0 0 354.796 354.796" style="enable-background:new 0 0 354.796 354.796;"
                                    xml:space="preserve">
                                    <g>
                                        <g id="Layer_5_58_">
                                            <g>
                                                <g>
                                                    ...
                                                    <path
                                                        d="M260.979,22.509c-51.816,0-93.818,42.005-93.818,93.818c0,51.814,42.002,93.82,93.818,93.82c51.814,0,93.817-42.006,93.817-93.82C354.796,64.514,312.793,22.509,260.979,22.509z M260.979,188.404c-39.808,0-72.076-32.271-72.076-72.076s32.268-72.075,72.076-72.075c39.806,0,72.073,32.27,72.073,72.075S300.785,188.404,260.979,188.404z">
                                                    </path>
                                                </g>
                                                <g>
                                                    <path
                    ...
                    <div class="icon-box-text">
                        <h3>SECURE PAYMENT<br />– EASY TO PAY –</h3>
                    </div>
                </div>
            </div>
        </div>
...
<section class="product-content">
    <div class="tabs">
        <div class="tabbed-product">
            <ul class="nav-center nav navbar tab-links">
                @foreach ($categoryFirstAnother as $item)
                    <li class="active"><a href="#tab_{{$item->slug}}">{{$item->name}}</a></li>
                @endforeach
