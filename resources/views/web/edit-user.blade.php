<div class="container">
    <div class="userEdit">
      ...
      <form class="frmEdit" action="{{route('users.edit-info', Auth::user()->id)}}" method="POST" enctype="multipart/form-data">
        @method('put')
        @csrf
    ...
    <div class="tab-pane" id="frmEditB">
        <form class="frmEdit" action="{{route('users.edit-password', Auth::user()->id)}}" method="POST" enctype="multipart/form-data">
            @method('post')
            @csrf
            <div class="form-group">
              ...
              <input class="txtConfirmPassword form-control" type="password" id="" name="newPassword_confirmation"/>
      ...
      {{-- <form action="" method="post">
        <div class="tab-pane" id="frmEditB">
            <div class="form-group">
              <label for="">Old Password</label>
              <input class="txtOldPassword form-control" type="password" id="" name="oldPassword" maxlength="10" value="" />
